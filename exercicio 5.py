...
try:
    ...
    print("Arquivo 'lista_a.txt' não encontrado. Continuando com o que for possível.")
...
try:
    ...
    print("Arquivo 'lista_b.txt' não encontrado. Continuando com o que for possível.")
...
print("Arquivo 'lista_uniq.txt' criado com os itens únicos e ordenados.")
